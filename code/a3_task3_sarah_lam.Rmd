...
```{r fig.cap = "This histogram shows the size distributions of purple and red urchins (diameter, cm). The purple urchins, shown in purple, have a normal looking distribution with a majority at  about 4.5cm. The red urchins, shown in red, also have a normal looking distribution but a shorter, wider curve, the mean apprea "}
